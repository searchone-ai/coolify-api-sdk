 ...
 */
const CreateDockerComposeApplicationBodySchema = z.object({
...
export class CreateDockerComposeApplicationRoute extends BaseRoute {
    private readonly config: RouteConfig<
        {},
        {},
        z.infer<typeof CreateDockerComposeApplicationBodySchema>,
        z.infer<typeof ApplicationResponseSchema>
    > = {
            method: 'POST' as const,
            path: '/applications/dockercompose',
            bodySchema: CreateDockerComposeApplicationBodySchema,
     ...
     */
    async execute(input: { body: z.infer<typeof CreateDockerComposeApplicationBodySchema> }) {
        return this.executeRoute(this.config, input);
    }
}

// Export types for external use
export type CreateDockerComposeApplicationBody = z.infer<typeof CreateDockerComposeApplicationBodySchema>;
