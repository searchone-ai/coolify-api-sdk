 ...
 */
const CreateDockerImageApplicationBodySchema = z.object({
...
export class CreateDockerImageApplicationRoute extends BaseRoute {
    private readonly config: RouteConfig<
        {},
        {},
        z.infer<typeof CreateDockerImageApplicationBodySchema>,
        z.infer<typeof ApplicationResponseSchema>
    > = {
            method: 'POST' as const,
            path: '/applications/dockerimage',
            bodySchema: CreateDockerImageApplicationBodySchema,
     ...
     */
    async execute(input: { body: z.infer<typeof CreateDockerImageApplicationBodySchema> }) {
        return this.executeRoute(this.config, input);
    }
}

// Export types for external use
export type CreateDockerImageApplicationBody = z.infer<typeof CreateDockerImageApplicationBodySchema>;
