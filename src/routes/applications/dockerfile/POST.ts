 ...
 */
const CreateDockerfileApplicationBodySchema = z.object({
...
export class CreateDockerfileApplicationRoute extends BaseRoute {
    private readonly config: RouteConfig<
        {},
        {},
        z.infer<typeof CreateDockerfileApplicationBodySchema>,
        z.infer<typeof ApplicationResponseSchema>
    > = {
            method: 'POST' as const,
            path: '/applications/dockerfile',
            bodySchema: CreateDockerfileApplicationBodySchema,
     ...
     */
    async execute(input: { body: z.infer<typeof CreateDockerfileApplicationBodySchema> }) {
        return this.executeRoute(this.config, input);
    }
}

// Export types for external use
export type CreateDockerfileApplicationBody = z.infer<typeof CreateDockerfileApplicationBodySchema>;
