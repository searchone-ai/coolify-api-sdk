 ...
 */
const CreatePrivateDeployKeyApplicationBodySchema = z.object({
...
export class CreatePrivateDeployKeyApplicationRoute extends BaseRoute {
    private readonly config: RouteConfig<
        {},
        {},
        z.infer<typeof CreatePrivateDeployKeyApplicationBodySchema>,
        z.infer<typeof ApplicationResponseSchema>
    > = {
            method: 'POST' as const,
            path: '/applications/private-deploy-key',
            bodySchema: CreatePrivateDeployKeyApplicationBodySchema,
     ...
     */
    async execute(input: { body: z.infer<typeof CreatePrivateDeployKeyApplicationBodySchema> }) {
        return this.executeRoute(this.config, input);
    }
}

// Export types for external use
export type CreatePrivateDeployKeyApplicationBody = z.infer<typeof CreatePrivateDeployKeyApplicationBodySchema>;
