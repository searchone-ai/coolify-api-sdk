 ...
 */
const CreateClickHouseDatabaseBodySchema = z.object({
...
export class CreateClickHouseDatabaseRoute extends BaseRoute {
    private readonly config: RouteConfig<
        {},
        {},
        z.infer<typeof CreateClickHouseDatabaseBodySchema>,
        z.infer<typeof DatabaseResponseSchema>
    > = {
            method: 'POST' as const,
            path: '/databases/clickhouse',
            bodySchema: CreateClickHouseDatabaseBodySchema,
     ...
     */
    async execute(input: { body: z.infer<typeof CreateClickHouseDatabaseBodySchema> }) {
        return this.executeRoute(this.config, input);
    }
}

// Export types for external use
export type CreateClickHouseDatabaseBody = z.infer<typeof CreateClickHouseDatabaseBodySchema>;
