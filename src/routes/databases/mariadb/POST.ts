 ...
 */
const CreateMariaDBDatabaseBodySchema = z.object({
...
export class CreateMariaDBDatabaseRoute extends BaseRoute {
    private readonly config: RouteConfig<
        {},
        {},
        z.infer<typeof CreateMariaDBDatabaseBodySchema>,
        z.infer<typeof DatabaseResponseSchema>
    > = {
            method: 'POST' as const,
            path: '/databases/mariadb',
            bodySchema: CreateMariaDBDatabaseBodySchema,
     ...
     */
    async execute(input: { body: z.infer<typeof CreateMariaDBDatabaseBodySchema> }) {
        return this.executeRoute(this.config, input);
    }
}

// Export types for external use
export type CreateMariaDBDatabaseBody = z.infer<typeof CreateMariaDBDatabaseBodySchema>;
