 ...
 */
const CreateMongoDBDatabaseBodySchema = z.object({
...
export class CreateMongoDBDatabaseRoute extends BaseRoute {
    private readonly config: RouteConfig<
        {},
        {},
        z.infer<typeof CreateMongoDBDatabaseBodySchema>,
        z.infer<typeof DatabaseResponseSchema>
    > = {
            method: 'POST' as const,
            path: '/databases/mongodb',
            bodySchema: CreateMongoDBDatabaseBodySchema,
     ...
     */
    async execute(input: { body: z.infer<typeof CreateMongoDBDatabaseBodySchema> }) {
        return this.executeRoute(this.config, input);
    }
}

// Export types for external use
export type CreateMongoDBDatabaseBody = z.infer<typeof CreateMongoDBDatabaseBodySchema>;
