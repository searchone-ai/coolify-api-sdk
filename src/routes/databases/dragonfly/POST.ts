 ...
 */
const CreateDragonflyDatabaseBodySchema = z.object({
...
export class CreateDragonflyDatabaseRoute extends BaseRoute {
    private readonly config: RouteConfig<
        {},
        {},
        z.infer<typeof CreateDragonflyDatabaseBodySchema>,
        z.infer<typeof DatabaseResponseSchema>
    > = {
            method: 'POST' as const,
            path: '/databases/dragonfly',
            bodySchema: CreateDragonflyDatabaseBodySchema,
     ...
     */
    async execute(input: { body: z.infer<typeof CreateDragonflyDatabaseBodySchema> }) {
        return this.executeRoute(this.config, input);
    }
}

// Export types for external use
export type CreateDragonflyDatabaseBody = z.infer<typeof CreateDragonflyDatabaseBodySchema>;
