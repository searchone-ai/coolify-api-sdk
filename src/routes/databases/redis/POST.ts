 ...
 */
const CreateRedisDatabaseBodySchema = z.object({
...
export class CreateRedisDatabaseRoute extends BaseRoute {
    private readonly config: RouteConfig<
        {},
        {},
        z.infer<typeof CreateRedisDatabaseBodySchema>,
        z.infer<typeof DatabaseResponseSchema>
    > = {
            method: 'POST' as const,
            path: '/databases/redis',
            bodySchema: CreateRedisDatabaseBodySchema,
     ...
     */
    async execute(input: { body: z.infer<typeof CreateRedisDatabaseBodySchema> }) {
        return this.executeRoute(this.config, input);
    }
}

// Export types for external use
export type CreateRedisDatabaseBody = z.infer<typeof CreateRedisDatabaseBodySchema>;
