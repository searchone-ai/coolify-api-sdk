 ...
 */
const CreateMySQLDatabaseBodySchema = z.object({
...
export class CreateMySQLDatabaseRoute extends BaseRoute {
    private readonly config: RouteConfig<
        {},
        {},
        z.infer<typeof CreateMySQLDatabaseBodySchema>,
        z.infer<typeof DatabaseResponseSchema>
    > = {
            method: 'POST' as const,
            path: '/databases/mysql',
            bodySchema: CreateMySQLDatabaseBodySchema,
     ...
     */
    async execute(input: { body: z.infer<typeof CreateMySQLDatabaseBodySchema> }) {
        return this.executeRoute(this.config, input);
    }
}

// Export types for external use
export type CreateMySQLDatabaseBody = z.infer<typeof CreateMySQLDatabaseBodySchema>;
