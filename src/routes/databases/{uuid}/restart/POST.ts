 ...
 */
const RestartDatabaseParamsSchema = z.object({
...
export class RestartDatabaseRoute extends BaseRoute {
    private readonly config: RouteConfig<
        z.infer<typeof RestartDatabaseParamsSchema>,
        {},
        {},
    ...
    > = {
            ...
            paramsSchema: RestartDatabaseParamsSchema,
...
export type RestartDatabaseParams = z.infer<typeof RestartDatabaseParamsSchema>;
